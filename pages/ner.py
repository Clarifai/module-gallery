...
with st.spinner("Finding Entities"):
    text_input = st.text_area("Press ⌘+Enter to rerun NER prediction:", "Eran lives in New York\nand works for Clarifai")

    response = predict_from_text(stub, auth.metadata, text_input, user_id, user_app_id, model_id, model_version_id)
